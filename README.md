...
Kodi tweaked for Armbian builds. This branch is meant to compile Kodi for ODROID XU4, and possibly other devices using X11/GLES and the v4l2_m2m interface.
